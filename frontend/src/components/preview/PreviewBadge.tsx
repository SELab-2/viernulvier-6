 ...
 */
export function PreviewBadge({ entityType, entityId, sessionId }: PreviewBadgeProps) {
    ...
    const isPreview = hasPreview(entityType, entityId, sessionId);
    ...
    return (
        <span
            ...
            onClick={() => clearPreviewFor(entityType, entityId, sessionId)}
            title={t("exitPreview")}
        >
            {t("previewMode")}
        </span>
