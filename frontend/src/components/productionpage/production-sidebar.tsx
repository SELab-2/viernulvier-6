    ...
    return (
        <aside className="flex flex-col">
            ...
            <div className="pb-6">
                ...
                <button
                    onClick={copyLink}
                    className="border-border text-muted-foreground hover:border-foreground hover:text-foreground mb-2 flex w-full cursor-pointer items-center justify-center gap-2 border bg-transparent px-2 py-2 font-mono text-[9px] tracking-[1.2px] uppercase transition-all"
                >
