...
const defaultCategories = new Set<string>(["productions"]);

const archiveSidebar = (props: Partial<React.ComponentProps<typeof ArchiveSidebar>> = {}) => (
    <ArchiveSidebar categories={categories} defaultCategories={defaultCategories} {...props} />
);

const renderArchiveSidebar = (props: Partial<React.ComponentProps<typeof ArchiveSidebar>> = {}) =>
    renderWithIntl(archiveSidebar(props));
...
describe("ArchiveSidebar component", () => {
    ...
    it("has productions checked by default", () => {
        renderArchiveSidebar();
    ...
    it("toggles categories on click", async () => {
        ...
        await user.click(productionsButton);
    ...
    it("switches back to year mode and removes date_mode param from URL", async () => {
        ...
        renderArchiveSidebar({ minYear: 2000 });
    ...
    it("updates year range labels when /stats arrives after mount (null draft tracks new bounds)", async () => {
        ...
        const { rerender } = renderArchiveSidebar();
    ...
    it("opens mobile sidebar when clicking the FAB button", async () => {
        const user = userEvent.setup();
        const { container } = renderArchiveSidebar();
